...
if selected == 'Home':
    ...
    st.markdown("<div style ='display:block;background:#8080801c;padding: 25px 15px 25px 15px;'><ul><li>The dashboard is created using Python and Streamlit</li><li>The dashboard consists of analysis on the Breast Cancer Disease dataset from the Sklearn library</li><li>Anyone can change the configurations of the charts using the dropdown button to check various results of the charts</li></li></div>", unsafe_allow_html=True)
